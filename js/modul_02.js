...
//     // Change code below this line
//   let totaleArray = firstArray.concat(secondArray);
//   let newArray;
//   if (totaleArray.length > maxLength) {
//    newArray = totaleArray.slice(0, maxLength);
    
//   }
//   else {
//     newArray = totaleArray;
//   }
//  return  newArray;
...
// ********************************************************************
// 23.
// якому будуть тільки ті елементи масиву numbers, які більші за значення параметра value (число).
